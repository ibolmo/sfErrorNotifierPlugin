<?php
/** @var $globalsTable sfOutputEscaper|string */
/** @var $message sfOutputEscaper|string */
/** @var $requestTable sfOutputEscaper|string */
/** @var $responseTable sfOutputEscaper|string */
/** @var $settingsTable sfOutputEscaper|string */
/** @var $traces sfOutputEscaper|array */
/** @var $url sfOutputEscaper|string */
/** @var $userTable sfOutputEscaper|string */
?>
